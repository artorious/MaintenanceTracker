...
class TestRouteCases(unittest.TestCase):
    ...
    def test_register_status(self):
        ...
        self.assertEqual(201, result.status_code, msg='Request POSTed')
    ...
    def test_register_Success_operation_message(self):
        ...
        self.assertIn('Account created', str(result.data))

    def test_register_handles_bad_request(self):
        """ Test endpoint returns message to user to indicate Bad request """
        ...
        self.assertEqual(404, result.status_code, msg='Resource not Found')

    def test_register_Failed_operation_message(self):
        """ Test endpoint returns message to user to indicate Pass/Fail """
        result = self.app.post(
            '/api/v1/registerss', 
            data=json.dumps(self.sample),
        ...
        self.assertIn('Account NOT created', str(result.data))
